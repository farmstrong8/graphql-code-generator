...
export const aTodoDetailsPageQueryAsTodo = createBuilder<TodoDetailsPageQueryAsTodo>({
  "__typename": "Query",
  todo: {
  "__typename": "Todo",
...
export const aTodoDetailsPageQueryAsError = createBuilder<TodoDetailsPageQueryAsError>({
  "__typename": "Query",
  todo: {
  "__typename": "Error",
...
export const aAuthorInlineFragmentFragment = createBuilder<AuthorInlineFragmentFragment>({
  "__typename": "Author",
...
export const aTodosPageWithInlineFragmentTodo = createBuilder<TodosPageWithInlineFragmentTodo>({
  "__typename": "Todo",
...
export const aTodosPageWithInlineFragmentQuery = createBuilder<TodosPageWithInlineFragmentQuery>({
  "__typename": "Query",
